...
Reflect.defineProperty(User.prototype, 'botSupport', {
  get: function (this: User) {
    return (
      ...
      ?? this.client.bot.database.users.update(this.id, { botSupport: false })
        .botSupport
    );
  },
  set: function (this: User, value: Boolean) {
    return this.client.bot.database.users.update(this.id, {
      botSupport: value,
    });
  },
});
...
Reflect.defineProperty(User.prototype, 'botAdmin', {
  get: function (this: User) {
    return (
      ...
      ?? this.client.bot.database.users.update(this.id, { botAdmin: false })
        .botAdmin
    );
  },
  set: function (this: User, value: Boolean) {
    return (
      this.client.bot.database.users.update(this.id, { botAdmin: value })
      ?? false
    );
  },
});
...
Reflect.defineProperty(User.prototype, 'botDeveloper', {
  get: function (this: User) {
    return (
      this.client.bot.database.users.get(this.id).botDeveloper
      ?? this.client.bot.database.users.update(this.id, { botDeveloper: false })
        .botDeveloper
    );
  },
  set: function (this: User, value: Boolean) {
